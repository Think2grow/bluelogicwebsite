...
```astro
import { getBaseOrganizationSchema } from "../utils/schema";
...
const schemas = [
  getBreadcrumbSchema(siteUrl, [{ name: "Home", url: "/" }])
];
---
