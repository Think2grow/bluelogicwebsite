...
1. **What is the total installed cost — including all components and labor?** No hidden installation fees.
2. **Is a service contract required?** Know what you're committing to long-term.
3. **What is the warranty?** And what does it cover — parts, labor, or both?
4. **Are the components NSF-certified?** And for which contaminants?
5. **Do you offer a price-match guarantee?** Blue Logic does — bring any written competing quote.
6. **What financing is available?** Blue Logic offers in-house financing with half down and flexible terms.
7. **Can you start with filtration and add RO later?** With Blue Logic, yes — the systems are designed to be upgradeable.
